...
public class KnightSmokeImpact2
extends SubInstantParticleEmitter {
    private static final LinearCurve C_FACTOR = new LinearCurve(new float[]{0.0f, 8.92f, 3.57f}, (subParticle, partial) -> Float.valueOf(((float)subParticle.age + partial.floatValue()) / 20.0f), (subParticle, partial) -> Float.valueOf((float)subParticle.lifeTime / 20.0f));
    ...
    protected KnightSmokeImpact2(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
        super(world, x, y, z, spriteSet, 60);
    ...
    protected SubParticle makeParticle() {
        ...
        subParticle.setVelocity(new Vec3(0.0, 2.0, 0.0), 30.0f * subParticle.random2);
        return subParticle;
    }
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new KnightSmokeImpact2(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
        }
    }
}
