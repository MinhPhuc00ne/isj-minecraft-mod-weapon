...
public class SoulSkeletonOnEntityTickUpdateProcedure {
    public static void execute(LevelAccessor world, Entity entity) {
        ...
        if (entity instanceof SoulSkeletonEntity) {
            SoulSkeletonEntity _datEntI = (SoulSkeletonEntity)entity;
            n = (Integer)_datEntI.getEntityData().get(SoulSkeletonEntity.DATA_attack_animtime);
        } else {
            n = 0;
        }
        if (n > 0) {
            ...
            if (entity instanceof SoulSkeletonEntity) {
                SoulSkeletonEntity _datEntI = (SoulSkeletonEntity)entity;
                n2 = (Integer)_datEntI.getEntityData().get(SoulSkeletonEntity.DATA_attack_animtime);
            } else {
                n2 = 0;
            }
            if (n2 == 14) {
            ...
            if (entity instanceof SoulSkeletonEntity) {
                int n3;
                SoulSkeletonEntity _datEntSetI = (SoulSkeletonEntity)entity;
                SynchedEntityData synchedEntityData = _datEntSetI.getEntityData();
                if (entity instanceof SoulSkeletonEntity) {
                    SoulSkeletonEntity _datEntI = (SoulSkeletonEntity)entity;
                    n3 = (Integer)_datEntI.getEntityData().get(SoulSkeletonEntity.DATA_attack_animtime);
                } else {
                    n3 = 0;
                }
                synchedEntityData.set(SoulSkeletonEntity.DATA_attack_animtime, (n3 - 1));
            }
        } else {
            int n4;
            if (entity instanceof SoulSkeletonEntity) {
                SoulSkeletonEntity _datEntI = (SoulSkeletonEntity)entity;
                n4 = (Integer)_datEntI.getEntityData().get(SoulSkeletonEntity.DATA_attack_cooldown);
            } else {
                n4 = 0;
            }
            if (n4 >= 15) {
                ...
                for (Entity entityiterator : _entfound) {
                    SoulSkeletonEntity _datEntSetI;
                    ...
                    if (entity instanceof SoulSkeletonEntity) {
                        _datEntSetI = (SoulSkeletonEntity)entity;
                        _datEntSetI.getEntityData().set(SoulSkeletonEntity.DATA_attack_cooldown, 0);
                    }
                    if (!(entity instanceof SoulSkeletonEntity)) break;
                    _datEntSetI = (SoulSkeletonEntity)entity;
                    _datEntSetI.getEntityData().set(SoulSkeletonEntity.DATA_attack_animtime, 20);
                    break;
                }
            } else {
                Vec3 _center = new Vec3(entity.getX(), entity.getY(), entity.getZ());
                ...
                for (Entity entityiterator : _entfound) {
                    ...
                    if (entity instanceof SoulSkeletonEntity) {
                        SoulSkeletonEntity _datEntI = (SoulSkeletonEntity)entity;
                        n5 = (Integer)_datEntI.getEntityData().get(SoulSkeletonEntity.DATA_attack_cooldown);
                    } else {
                        n5 = 0;
                    }
                    synchedEntityData.set(SoulSkeletonEntity.DATA_attack_cooldown, (n5 + 1));
                    break;
                }
            }
        }
        if (Math.random() < 0.05) {
            if (world instanceof ServerLevel _level) {
                _level.sendParticles((ParticleOptions)ParticleTypes.SOUL, entity.getX(), entity.getY() + 1.5, entity.getZ(), 1, 0.4, 0.4, 0.4, 0.0);
            }
