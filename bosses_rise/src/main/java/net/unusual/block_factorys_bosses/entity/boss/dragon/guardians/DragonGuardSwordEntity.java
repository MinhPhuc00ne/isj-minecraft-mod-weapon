...
import net.unusual.block_factorys_bosses.procedures.DragonGuardSwordOnEntityTickUpdateProcedure;
...
public class DragonGuardSwordEntity
extends Monster
implements GeoEntity {
    public static final EntityDataAccessor<Integer> DATA_attack_cooldown = SynchedEntityData.defineId(DragonGuardSwordEntity.class, (EntityDataSerializer)EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> DATA_attack_animtime = SynchedEntityData.defineId(DragonGuardSwordEntity.class, (EntityDataSerializer)EntityDataSerializers.INT);
    ...
    public DragonGuardSwordEntity(EntityType<DragonGuardSwordEntity> type, Level world) {
        super(type, world);
        this.xpReward = 6;
        this.setNoAi(false);
    }
    ...
    public void baseTick() {
        super.baseTick();
        DragonGuardSwordOnEntityTickUpdateProcedure.execute((LevelAccessor)this.level(), (Entity)this);
    }

    public static void init(RegisterSpawnPlacementsEvent event) {
        event.register((EntityType)BossesRiseEntities.DRAGON_GUARD_SWORD.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.getDifficulty() != Difficulty.PEACEFUL, RegisterSpawnPlacementsEvent.Operation.REPLACE);
    }
