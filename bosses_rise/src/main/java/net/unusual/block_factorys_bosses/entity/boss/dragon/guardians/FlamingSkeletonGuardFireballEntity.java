...
import net.unusual.block_factorys_bosses.procedures.FlamingSkeletonGuardFireballOnEntityTickUpdateProcedure;
...
public class FlamingSkeletonGuardFireballEntity
extends Monster
implements GeoEntity {
    public static final EntityDataAccessor<Integer> DATA_attack_cooldown = SynchedEntityData.defineId(FlamingSkeletonGuardFireballEntity.class, (EntityDataSerializer)EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> DATA_attack_animtime = SynchedEntityData.defineId(FlamingSkeletonGuardFireballEntity.class, (EntityDataSerializer)EntityDataSerializers.INT);
    ...
    public FlamingSkeletonGuardFireballEntity(EntityType<FlamingSkeletonGuardFireballEntity> type, Level world) {
        super(type, world);
        this.xpReward = 8;
        this.setNoAi(false);
    }
    ...
    public void baseTick() {
        super.baseTick();
        FlamingSkeletonGuardFireballOnEntityTickUpdateProcedure.execute((LevelAccessor)this.level(), (Entity)this);
    }

    public static void init(RegisterSpawnPlacementsEvent event) {
        event.register((EntityType)BossesRiseEntities.FLAMING_SKELETON_GUARD_FIREBALL.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.getDifficulty() != Difficulty.PEACEFUL, RegisterSpawnPlacementsEvent.Operation.REPLACE);
    }
