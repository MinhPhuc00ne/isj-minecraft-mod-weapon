...
import net.unusual.block_factorys_bosses.procedures.SoulKnightWitherSkeletonOnEntityTickUpdateProcedure;

public class SoulKnightWitherSkeletonEntity
extends Monster {
    public final AnimationState attackAnimationState = new AnimationState();
    public final AnimationState idleAnimationState = new AnimationState();
    public static final EntityDataAccessor<Integer> DATA_attack_cooldown = SynchedEntityData.defineId(SoulKnightWitherSkeletonEntity.class, (EntityDataSerializer)EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> DATA_attack_animtime = SynchedEntityData.defineId(SoulKnightWitherSkeletonEntity.class, (EntityDataSerializer)EntityDataSerializers.INT);

    public SoulKnightWitherSkeletonEntity(EntityType<SoulKnightWitherSkeletonEntity> type, Level world) {
        super(type, world);
        this.xpReward = 7;
        this.setNoAi(false);
    }
