...
public class PirateRookEntity
extends Monster
implements GeoEntity,
OwnableByAllEntity,
KrakenSpawnerBlockEntity.SpawnerTied {
    public static final EntityDataAccessor<Integer> ATTACK_COOLDOWN = SynchedEntityData.defineId(PirateRookEntity.class, (EntityDataSerializer)EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> ATTACK_ANIMTIME = SynchedEntityData.defineId(PirateRookEntity.class, (EntityDataSerializer)EntityDataSerializers.INT);
    public static final EntityDataAccessor<Optional<UUID>> OWNER_UUID = SynchedEntityData.defineId(PirateRookEntity.class, (EntityDataSerializer)EntityDataSerializers.OPTIONAL_UUID);
    ...
    public PirateRookEntity(EntityType<PirateRookEntity> type, Level world) {
        super(type, world);
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(1, new OwnableByAllEntity.OwnerHurtByTargetGoal<PirateRookEntity>(this));
        this.targetSelector.addGoal(2, new OwnableByAllEntity.OwnerHurtTargetGoal<PirateRookEntity>(this));
        this.targetSelector.addGoal(3, new OwnableByAllEntity.DoNotAttackOwnerGoal<PirateRookEntity, Player>(this, Player.class, false, false));
    ...
    public static void init(RegisterSpawnPlacementsEvent event) {
        event.register((EntityType)BossesRiseEntities.PIRATE_ROOK.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.getDifficulty() != Difficulty.PEACEFUL, RegisterSpawnPlacementsEvent.Operation.REPLACE);
    }
