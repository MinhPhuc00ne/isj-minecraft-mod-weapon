...
public class UndyingTentacleRenderer
extends GeoItemRenderer<UndyingTentacleItem> {
    public UndyingTentacleRenderer() {
        super((GeoModel)new CustomItemGeoModel(BossesRise.prefix("undying_tentacle")).withAltTexture(BossesRise.prefix("undying_tentacle_model")));
    }
}
