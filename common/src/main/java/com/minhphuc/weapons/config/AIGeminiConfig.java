...
public class AIGeminiConfig {
    ...
    public static void loadConfig() {
        try {
            Path configPath = Platform.getConfigFolder().resolve("weapons_ai_config.json");
    ...
    public static String getConfigAbsolutePath() {
        try {
            return Platform.getConfigFolder().resolve("weapons_ai_config.json").toFile().getAbsolutePath();
        } catch (Exception e) {
